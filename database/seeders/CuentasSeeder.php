...
class CuentasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('cuentas')->insert(
            ...
            ['user' => 'user4', 'password' => Hash::make('password123'), 'nombre' => 'Peter', 'apellido' => 'Jones', 'perfil_id' => 3],
            ...
            ['user' => 'user7', 'password' => Hash::make('password123'), 'nombre' => 'Emily', 'apellido' => 'Green', 'perfil_id' => 3],
            ...
            ['user' => 'user10', 'password' => Hash::make('password123'), 'nombre' => 'Thomas', 'apellido' => 'Blue', 'perfil_id' => 3],
        );
    }
}
